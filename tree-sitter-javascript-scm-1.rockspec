local git_ref = 'de1e682289a417354df5b4437a3e4f92e0722a0f'
local modrev = 'scm'
local specrev = '1'
...
description = {
  summary = 'tree-sitter parser and Neovim queries for javascript',
...
source = {
  ...
  dir = 'tree-sitter-javascript-' .. 'de1e682289a417354df5b4437a3e4f92e0722a0f',
}
