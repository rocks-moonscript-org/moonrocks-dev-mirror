...
build = {
   ...
   modules = {
      ...
      ["webscraper.filters.filters.repository.to_boolean"] = "src/filters/filters/repository/to_boolean.lua",
      ...
      ["webscraper.filters.validators.repository.is_boolean"] = "src/filters/validators/repository/is_boolean.lua",
