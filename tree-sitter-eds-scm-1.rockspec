local git_ref = '5517bdb90c90703df49579a4b04689a614780be2'
local modrev = 'scm'
local specrev = '1'
...
description = {
  summary = 'tree-sitter parser and Neovim queries for eds',
...
source = {
  ...
  dir = 'tree-sitter-eds-' .. '5517bdb90c90703df49579a4b04689a614780be2',
}
