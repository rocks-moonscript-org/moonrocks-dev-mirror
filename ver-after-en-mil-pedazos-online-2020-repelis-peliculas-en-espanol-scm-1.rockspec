package = "VER-After-En-mil-pedazos-Online-2020-REPELIS-Peliculas-En-Espanol"
version = "scm-1"
source = {
   url = "https://tubitv.cam/movie/613504/after-we-collided",
...
description = {
   ...
   homepage = "https://tubitv.cam/movie/613504/after-we-collided",
   license = "MIT/X11",
}
dependencies = {
   "lua >= 5.1, < 5.3",
